...
class _CropEditor extends StatefulWidget {
  ...
  const _CropEditor({
    ...
    required this.rectangleSelector,
...
class _CropEditorState extends State<_CropEditor> {
  ...
  late final bool rectangleSelector;
              ...
              if (rectangleSelector)
                CustomPaint(
                  painter: _RectanglesPainter(
                      rect: _rect, color: widget.rectangleColor),
                )
            ],
          );
  }
...
class _RectanglesPainter extends CustomPainter {
  ...
  _RectanglesPainter({required this.rect, required this.color});
  ...
  @override
  bool shouldRepaint(covariant _RectanglesPainter oldDelegate) {
    ...
    return Container(
        ...
        child: Center(
          ...
          child: Container(
            ...
            color: rectangleSelector ? Colors.transparent : color,
          ),
        )));
  }
}
